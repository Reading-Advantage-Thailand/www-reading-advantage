...
10. Test conventions are documented in `conductor/code_styleguides/testing.md`.
...
- [ ] `conductor/code_styleguides/testing.md` documents the test file naming convention, the import aliases available, and how to mock `next-international` in tests.
