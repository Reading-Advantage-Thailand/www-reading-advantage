...
- [ ] Add a brief section to `conductor/product-guidelines.md` (or a new `conductor/seo-guidelines.md`) documenting: how to add metadata to new pages, the title format convention, how to add structured data
