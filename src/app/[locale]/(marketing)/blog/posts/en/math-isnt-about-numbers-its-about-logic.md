...
1. Student memorizes procedures for basic problems
2. Student encounters a problem requiring reasoning
3. Student cannot solve it using memorized steps
4. Student concludes "I'm bad at math"
5. Student avoids math, misses opportunities to develop reasoning
6. Student falls further behind, reinforcing the belief
