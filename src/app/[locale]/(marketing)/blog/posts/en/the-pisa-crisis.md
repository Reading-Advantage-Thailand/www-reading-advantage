...
date: "2026-04-23"
excerpt: "Analyzing why Thai PISA scores are dropping and how functional literacy is the key to improving mathematics performance."
...
1. **Poor reading → Cannot understand math problems**
2. **Cannot understand problems → Cannot solve them**
3. **Cannot solve problems → Fails exams**
4. **Fails exams → Loses confidence**
5. **Loses confidence → Avoids math entirely**
