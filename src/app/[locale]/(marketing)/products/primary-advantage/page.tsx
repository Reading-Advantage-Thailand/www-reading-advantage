  ...
  return (
    <main className="min-h-screen">
      ...
      <Hero
        title={
          <>
            <div className="flex justify-center mb-8 animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="animate-in fade-in slide-in-from-right-8 duration-500 transition-all duration-300 hover:-translate-y-1" style={{ animationDelay: "100ms" }}>
                <Card className="bg-white/10 backdrop-blur-md border border-white/20 h-full shadow-modern hover:shadow-glow">
                  <CardHeader className="text-center pb-4">
