...
**Acceptance Criteria**:
- [ ] `package.json` no longer includes Firebase/auth packages
- [ ] AuthContext provider and hooks removed (or replaced with stubs if needed)
- [ ] `.env` docs cleaned up; CI configs updated
- [ ] Build output verified to exclude Firebase bundles
